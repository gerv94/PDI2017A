========================================================================
    APLICACIÓN DE WIN32: PDI2017A Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación PDI2017A.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación PDI2017A.
...
PDI2017A.ico
    Éste es un archivo de icono, que se utiliza como el icono de la aplicación (32x32). Este icono está incluido en el archivo principal de recursos PDI2017A.rc.

small.ico
    Este es un archivo de icono, que contiene una versión menor (16x16) del icono de la aplicación. Este icono está incluido en el archivo principal de recursos PDI2017A.rc.

/////////////////////////////////////////////////////////////////////////////
Otros archivos estándar:

StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado PDI2017A.pch y un archivo de tipos precompilados llamado StdAfx.obj.
